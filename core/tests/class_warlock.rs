use nat20_core::components::skill::Skill;
use nat20_core::{
    components::{
...
fn warlock_eldritch_blast(#[case] warlock_level: u8, #[case] expected_beams: u8) {
    ...
    scenario
        ...
        .actor("warlock")
        .damage_roll(
            DamageComponent::new(DiceSet::new(2, DieSize::D10), DamageType::Force), // Rolls twice on crit
...
fn warlock_hex_damage() {
    ...
    scenario
        ...
        .damage_roll(
            DamageComponent::new(
                DiceSet::new(2, DieSize::D10), // Rolls twice on crit
                DamageType::Force,
            ),
            DamageSource::Spell("spell.eldritch_blast".into()),
        )
    ...
    scenario
        ...
        .damage_dealt(
            "fighter",
            DamageComponent::new(
                DiceSet::new(2, DieSize::D6), // Rolls twice on crit
                DamageType::Necrotic,
            ),
            DamageSource::Spell("spell.eldritch_blast".into()),
        )
